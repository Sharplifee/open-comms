...
EXPECTED = {
    ...
    "public_lines":     {"p_device_id", "p_lat", "p_lon"},
    "set_line_public":  {"p_squad_id", "p_device_id", "p_public"},
    "ask_to_join":      {"p_squad_id", "p_device_id", "p_display_name"},
    "pending_requests": {"p_squad_id", "p_device_id"},
    "answer_request":   {"p_squad_id", "p_host_device", "p_device_id", "p_grant"},
    "request_answer":   {"p_squad_id", "p_device_id"},
